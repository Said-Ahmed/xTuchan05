...
from src.xtuchan.features.auth.auth import get_password_hash, authenticate_user, create_access_token
from src.xtuchan.features.auth.dao import UsersDAO
from src.xtuchan.features.auth.dependencies import get_current_user
from src.xtuchan.features.auth.exceptions import UserAlreadyExistsException, IncorrectEmailOrPasswordException
from src.xtuchan.features.auth.models import Users
from src.xtuchan.features.auth.schemas import SUserAuth, SUserRegister
router = APIRouter(
    prefix='/auth',
